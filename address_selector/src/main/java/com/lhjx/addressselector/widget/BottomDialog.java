...
import com.lhjx.addressselector.data.JsonAddressData;
import com.lhjx.addressselector.utils.Dev;
...
public class BottomDialog extends Dialog {
    ...
    private void init(Context context) {
        selector = new AddressSelector(context, new JsonAddressData());
        setContentView(selector.getView());
        Window window = getWindow();
        WindowManager.LayoutParams params = window.getAttributes();
        params.width = WindowManager.LayoutParams.MATCH_PARENT;
        params.height = Dev.dp2px(context, 375);
    ...
    public void setProvinceCityMode(boolean mode) {
        this.selector.setProvinceCityMode(mode);
    }
