...
//        headers.put(VERSION_CODE, String.valueOf(SystemUtils.getVersionCode(NetManager.sContext)));

        //cookie
//        String sessionId = PreferencesUtils.getString(NetManager.sContext, PreferenceConstant.COOKIE_SESSION_ID);
