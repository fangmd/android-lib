...
public class ZRXMediaGrid extends SquareFrameLayout implements View.OnClickListener {

    private ImageView mThumbnail;
    private ZRXCheckView mCheckView;
    ...
    public ZRXMediaGrid(Context context) {
        super(context);
        init(context);
    }

    public ZRXMediaGrid(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    private void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.media_grid_content_zrx, this, true);
    ...
    public void setOnMediaGridClickListener(ZRXMediaGrid.OnMediaGridClickListener listener) {
        mListener = listener;
    }
    ...
    public interface OnMediaGridClickListener {
        ...
        void onCheckViewClicked(ZRXCheckView checkView, Item item, RecyclerView.ViewHolder holder);
    }
