(function () {
    ...
    // add
    function androidCallback(funName, routeMeta, callback) {
    ...
    function NativePageController(AppFun, AppUrl, Callback) {
        if (window["WebViewJavascriptBridge"]) {
    ...
    function androidRegister(funcName, callback) {
        connectWebViewJavascriptBridge(function (bridge) {
            bridge.registerHandler(funcName, callback);
        })
    }

    function NativePageRegister(funcName, callback) {
    ...
    var JSNative = window.JSNative = {
        NativePageRegister: NativePageRegister,
        NativePageController: NativePageController,
